...
void read_pars(struct ParList *theParList, char filename[])
{
    ...
    readvar(filename, "BCX1Inner",      VAR_INT, &(theParList->bc1a));
    readvar(filename, "BCX1Outer",      VAR_INT, &(theParList->bc1b));
    readvar(filename, "BCX2Inner",      VAR_INT, &(theParList->bc2a));
    readvar(filename, "BCX2Outer",      VAR_INT, &(theParList->bc2b));
    readvar(filename, "BCX3Inner",      VAR_INT, &(theParList->bc3a));
    readvar(filename, "BCX3Outer",      VAR_INT, &(theParList->bc3b));
    readvar(filename, "Nx1",            VAR_INT, &(theParList->nx1));
    readvar(filename, "Nx2",            VAR_INT, &(theParList->nx2));
    readvar(filename, "Nx3",            VAR_INT, &(theParList->nx3));
    ...
    readvar(filename, "X3min",          VAR_DBL, &(theParList->x3min));
    readvar(filename, "X3max",          VAR_DBL, &(theParList->x3max));
    readvar(filename, "X3Type",         VAR_INT, &(theParList->x3type));
    readvar(filename, "X3PiFac",        VAR_INT, &(theParList->x3pifac));
    ...
    readvar(filename, "GeomPar1",       VAR_DBL, &(theParList->geomPar1));
    readvar(filename, "GeomPar2",       VAR_DBL, &(theParList->geomPar2));
    readvar(filename, "GeomPar3",       VAR_DBL, &(theParList->geomPar3));
    readvar(filename, "GeomPar4",       VAR_DBL, &(theParList->geomPar4));
...
void print_pars(struct ParList *theParList, char filename[])
{
    ...
    fprintf(f, "BCX3Inner %d\n", theParList->bc3a);
    fprintf(f, "BCX3Outer %d\n", theParList->bc3b);
    fprintf(f, "Nx1 %d\n", theParList->nx1);
    fprintf(f, "Nx2 %d\n", theParList->nx2);
    fprintf(f, "Nx3 %d\n", theParList->nx3);
    fprintf(f, "Nghost %d\n", theParList->nghost);
    ...
    fprintf(f, "GeomPar1 %g\n", theParList->geomPar1);
    fprintf(f, "GeomPar2 %g\n", theParList->geomPar2);
    fprintf(f, "GeomPar3 %g\n", theParList->geomPar3);
    fprintf(f, "GeomPar4 %g\n", theParList->geomPar4);
    fprintf(f, "Init %d\n", theParList->init);
